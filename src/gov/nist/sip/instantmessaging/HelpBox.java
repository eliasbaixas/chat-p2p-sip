...
public class HelpBox extends Dialog {
	...
	private static Logger logger = Logger.getLogger(HelpBox.class);
	...
	public HelpBox() {
		...
		try {
			...
			helpFile = new File(
					"./configuration/gov/nist/sip/instantmessaging/configuration/help.txt");
			...
			// logger.debug("color:"+color.equals(Color.white));
			...
			BufferedReader buffReader = new BufferedReader(
					new InputStreamReader(new FileInputStream(helpFile)));
			String line = null;
