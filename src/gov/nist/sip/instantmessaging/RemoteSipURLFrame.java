...
public class RemoteSipURLFrame extends JFrame {
	...
	public void initComponents() {
		...
		remoteSipURLLabel
				.setToolTipText("Your contact: (format: sip:user@nist.gov)");
		...
		remoteSipURLLabel
				.setBackground(InstantMessagingGUI.labelBackGroundColor);
		...
		remoteSipURLTextField
				.setBackground(InstantMessagingGUI.textBackGroundColor);
		...
		remoteSipURLTextField.setBorder(BorderFactory
		...
		try {
			...
			if (text == null || text.trim().equals("")
				...
				new AlertInstantMessaging(
						"You must set the contact sip URL!!!",
