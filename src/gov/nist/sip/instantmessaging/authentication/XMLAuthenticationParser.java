...
public class XMLAuthenticationParser extends DefaultHandler {
	...
	private static Logger logger = Logger
			.getLogger(XMLAuthenticationParser.class);
	...
	public void startDocument() throws SAXException {
		try {
			logger.info("DebugIM, XMLAuthenticationParser, startDocument(): "
	...
	public void endDocument() throws SAXException {
		try {
			logger.debug("DebugIM, XMLAuthenticationParser, endDocument(): "
	...
	public void writeToXMLFile(Vector usersTagList) {
		try {
			...
			logger.error(
					"DebugIM, XMLAuthenticationParser, writeToXMLFile(), exception"
							+ " raised:", e);
